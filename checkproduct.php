...
<html lang="en">
  <head>
    ...
    <title>SecureSupply - Supply Chain DAPP</title>
    <link rel="shortcut icon" src="images/fibble.png" type="image/png" />
  ...
  ?>
  <body class="" style="background-color: #00008b;">
    <?php
    include "navbar.php"
    ?>
    <center>
  ...
  <?php }else{
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("SecureSupply is a Blockchain-based logistics app that enables end-to-end tracking of products. By scanning product QR codes, customers gain access to detailed information, ensuring the authenticity and quality of their purchases.");
    });
