...
<html lang="en">
  <head>
    ...
    <title>SecureSupply - Decentralized Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to SecureSupply - The Supply Chain DAPP</h4>
            <p style="max-width: 80%;">
            SecureSupply is a Blockchain-based logistics app that enables end-to-end tracking of products. By scanning product QR codes, customers gain access to detailed information,which ensures the authenticity and quality of their purchases.            </p>
